        ...
        <div id="cart" class="col-md-9"><!---col-md-9 start---->
            ...
            <div class="box"><!---box start---->
                ...
                <form action=<?php
							...
							?>      method="GET" enctype="multipart/form-data"><!---form start---->
                ...
                <?php//print_r ($_SESSION["wish"] );?>
                    ...
                    <tr><!---tr start---->
                        ...
                        <td>
							 ...
							 <text center><input class="btn btn-warning" type="button" value="Remove" name="delete_item" style="width:80px" onclick="window.location='../remove_wish.php?id=<?php echo $i;?>'"></text center>
                    ...
                    */?>
                    ...
                    <div class="box-footer"><!---box-footer start---->
                        ...
                        <div class="pull-right"><!---pul right start-->
							...
							<p class="text-center buttons"><button type="submit" class="btn btn-primary i fa fa-shopping-cart" name="ct" value="true" > Add to cart </button></p>  
...
if(isset($_SESSION["user"])){
	...
	foreach($_SESSION["wish"] as $keys => $values){
		$result=mysqli_query($con,"INSERT into wish_list  (	WishListNo, UserName, ItemID, Qty, NewPrice, color, size)values
