...
<div id="content"><!----content start---->
    ...
    <div class="container"><!----container start---->
        ...
        <div class="col-md-12"><!---col-md-9 start--->
            ...
            if(isset($_GET['Offer_ID'])){//////offer name  load start/////

                $Offer_id = $_GET['Offer_ID'];
        
                $res1 = mysqli_query($db,"SELECT * FROM offer where OfferID=' $Offer_id'");

                while($row=mysqli_fetch_array($res1)){
                  $offer_name = $row['O_Name'];
            ...
            <?php
              if(isset($_GET['Offer_ID'])){//////offer products load start/////
                ...
                if(isset($_GET['page'])){
                 ...
                 $res1 = mysqli_query($db,"SELECT * FROM item WHERE Offer_ID=' $Offer_id' order by 1 DESC LIMIT $start_from,$per_page");
                ...
                <?php
                    ...
                    $total_pages = ceil($total_records / $per_page);
                        ...
                        echo "
                            ...
                            <li>
                                <a href='offer_items.php?Offer_ID=".$offer_id."page=1'>  ".'First Page'." </a>
                            </li>
                        ...
                        for($i=1; $i<=$total_pages; $i++){
                            ...
                            <li>
                                <a href='offer_items.php?Offer_ID=".$offer_id."page=".$i."'>  ".$i." </a>
                            </li>
                        ...
                        echo "
                            ...
                            <li>
                                <a href='offer_items.php?Offer_ID=".$offer_id."page=$total_pages'>  ".'Last Page'." </a>
                            </li>
                        
                        ";

                
                    }///offer products loading end/////////////////
