    ...
    <div class="col-lg-12"><!----col-lg-12 start--->
       <ol class="breadcrumb"><!----breadcrumb start--->       
            <li class="active"><!----active start---> 
                <i class="fa fa-dashboard"></i> Dashboard / Check Inbox
            </li>     <!----active end--->    
        </ol><!----breadcrumb end--->  
    </div><!----col-lg-12 end--->
</div><!----row end--->
        ...
        <div class="panel panel-default"><!----panel panel-default start--->
            <div class="panel-heading"><!----panel heading start--->
                <h3 class="panel-title"><!---panel-title start--->
                    <i class="fa fa-money fa-fw"></i>  Check Inbox
                </h3><!----panel-title end--->
                    ...
                    <table class="table table-striped table-bordered table-hover"><!---table table-striped table-bordered table-hover start--->
                        ...
                        <tbody><!---tbody start--->
                            ...
                            */
                            ...
                            $get_msg = "select * from message where Received_by='$id'";
                            ...
                            while($row_msg=mysqli_fetch_array($run_msg)){
                               ...
                               <tr><!---tr start--->
                                    ...
                                    <td>Admin</td>
									 <td><?php echo $date; ?></td>   
                                        <td><?php echo $time; ?></td>
                                         ...
                                         <td>   
                                         <a href="message_us.php?cus_id=<?php echo $cus_id; ?>">
                                    ...
                                    <td>   
                                         <a href="delete_inbox.php?del_inbox=<?php echo $mno; ?>">
