...
function wishListValue(){
  ...
  window.location="customer/wishlist.php?ItemID="+iid+"&Colour="+clr+"&product_size="+size+"&quantity="+qty+"&addtowish="+true;
            ...
            <div class="col-sm-6"><!---col-sm-6 start------>
                ...
                <div class="col-sm-6"><!-------col-sm-6 start------->
                    <div class="box"><!-------box start------->
                        ...
                        <form action="customer/cart.php" class="form-horizontal" method="GET"><!---form-horizontal start--->
                ...
                <span style='color:red;font-size:20px;font-weight:400;text-decoration:line-through;margin-left:3px;display:inline-block'> Rs. <?php echo $pro_price ?> /= </span>
							...
							<input type ="button"  Onclick="wishListValue()" value="Add to Wishlist" class="btn btn-primary i fa fa-shopping-cart">
			<?php }}?>
