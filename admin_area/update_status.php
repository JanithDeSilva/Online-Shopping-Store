            ...
            <div class="panel-body"><!----panel-body start--->
                <form method="POST" class="form-horizontal" enctype="multipart/form-data"><!---form-horizontal start--->
                    ...
                    <div class="form-group"><!----form-group start--->
                        <label class="col-md-3 control-label"> Current Order Status</label>
                            <div class="col-md-6"><!----col-md-6 start--->

                                <input name="Current_order_status" type="text" class="form-control" required value="<?php echo  $order_status; ?>" readonly>
					 ...
					 <div class="form-group"><!----form-group start--->
                        <label class="col-md-3 control-label"> New Order Status</label>
                            <div class="col-md-6"><!----col-md-6 start--->

                                <select name="order_status" type="text" class="form-control" required value="<?php echo  $order_status; ?>">
								
								<option>Shipped</option>
								<option>Successfully delivered</option>
								<option></option>
								<option></option>
